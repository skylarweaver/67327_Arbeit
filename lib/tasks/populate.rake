namespace :db do
  ...
  task :populate => :environment do
    ...
    pswd = %w[123456 123456789 password iloveyou qwerty abc123 monkey 654321 letmein 1q2w3e john316].sample
    u.password = pswd
    u.password_confirmation = pswd
    u.active = true
    u.role = "admin"
    u.save!
    ...
    16.times do 
      ...
      pswd = %w[123456 123456789 password iloveyou qwerty princess abc123 monkey 654321 letmein 1q2w3e john316].sample
      user.password = pswd
    ...
    16.times do 
      ...
      task.priority = ["high","med","low"].sample    
